...
data_1 = [
    ...
    ("a", "b", "c", "+3 (805) 055-5555", ValueError),
...
data_2 = [
    ...
    ("Oo'hgh H-JH", "20", "London", "+3 (123) 456-7890",
     "HELLO, OO'HGH H-JH! YOUR AGE IS 20. YOU LIVE IN LONDON. YOUR PHONE NUMBER IS +3 (123) 456-7890."),
    ("O-o l'k", "20", "London", "+3 (123) 456-7890",
     "HELLO, O-O L'K! YOUR AGE IS 20. YOU LIVE IN LONDON. YOUR PHONE NUMBER IS +3 (123) 456-7890."),
    ("O-o'p l'k j'k-o h'h", "20", "London", "+3 (123) 456-7890",
     "HELLO, O-O'P L'K J'K-O H'H! YOUR AGE IS 20. YOU LIVE IN LONDON. YOUR PHONE NUMBER IS +3 (123) 456-7890."),
